...
parcelHelpers.export(exports, "Greek", ()=>(0, _greek.Greek));
...
},{"./frame":"bCL66","./data":"6C1am","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./label":"dyAII","./greek":"5t3Ja","./plots/vectorplot":"83AEn","./plots/scatterplot":"kKQFI"}],"bCL66":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "FallbackLabel", ()=>FallbackLabel);
var _three = require("three");
...
var _helvetikerRegularTypefaceJson = require("./fonts/helvetiker_regular.typeface.json");
var _helvetikerRegularTypefaceJsonDefault = parcelHelpers.interopDefault(_helvetikerRegularTypefaceJson);
class Label {
    constructor(position, text, size = 0.2, color = 0x000000){
        this.text = new (0, _troikaThreeText.Text)();
        this.text.text = text;
...
class FallbackLabel {
    constructor(position, text, size = 1, color = 0x000000){
        this.position = position;
        this.text = text;
        this.size = size;
        this.color = color;
        const geometry = new (0, _textGeometry.TextGeometry)(this.text, {
            font: new (0, _fontLoader.Font)((0, _helvetikerRegularTypefaceJsonDefault.default)),
            size: this.size,
            height: 0.01,
            curveSegments: 25,
            bevelEnabled: false
        ...
        this.drawable = new (0, _three.Mesh)(geometry, material);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","three":"ktPTu","three/examples/jsm/loaders/FontLoader":"h0CPK","three/examples/jsm/geometries/TextGeometry":"d5vi9","./fonts/helvetiker_regular.typeface.json":"7Ewuc","troika-three-text":"7YS8r"}],"7Ewuc":[function(require,module,exports) {
...
},{}],"5t3Ja":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class VectorPlot extends (0, _plot.Plot) {
    static #_ = this.defaultConfig = (0, _vectorplotConfig.vectorplotDefaultConfig);
    constructor(origin, target, config){
        super();
        this.origin = origin;
        this.target = target;
        this.config = {
            ...VectorPlot.defaultConfig,
            ...config
        };
        this.drawables = [];
    ...
    createProjection(plane) {
        ...
        const projectionLine = new (0, _three.Line)(projectionGeometry, lineMaterial).computeLineDistances();
        const connectionGeometry = new (0, _three.BufferGeometry)().setFromPoints([
            projectedVector,
            this.target
        ]);
        if (projectionConfig) drawables.push(projectionLine);
        return [
...
},{"three":"ktPTu","../axes":"2EXQV","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../plot":"hsxxN","./vectorplot.config":"2jQnK"}],"hsxxN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "vectorplotDefaultConfig", ()=>vectorplotDefaultConfig);
const vectorplotDefaultConfig = {
    linestyle: {
        color: 0x000000
    },
    xy: {
...
},{"three":"ktPTu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../plot":"hsxxN"}]},["gBWlm","h7u1C"], "h7u1C", "parcelRequire9513")
