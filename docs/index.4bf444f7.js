...
parcelHelpers.export(exports, "PlanePlot", ()=>(0, _planeplot.PlanePlot));
...
var _planeplot = require("./plots/planeplot");

},{"./frame":"bCL66","./plots/scatterplot":"kKQFI","./plots/vectorplot":"83AEn","./label":"dyAII","./glyph":"8wG4Z","./data":"6C1am","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./plots/planeplot":"kb2Cn"}],"bCL66":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Frame extends (0, _three.Scene) {
    ...
    constructor(canvas, size = 10, axesParams, gridParams, background){
        super();
        this.canvas = canvas;
        this.size = size;
        this.observer = new ResizeObserver(()=>this.onCanvasResize());
        this.scene = new (0, _three.Scene)();
        this.scene.background = new (0, _three.Color)(background?.color || 0xffffff);
    ...
    setAxesAndGrids(params, gridParams) {
        const axes = new (0, _axes.Axes)(this.size, this.size, this.size, params, gridParams);
...
},{"three":"ktPTu","three/examples/jsm/controls/OrbitControls":"7mqRv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./axes":"2EXQV"}],"2EXQV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Axis extends (0, _line2.Line2) {
    ...
    getLabel(params) {
        return new (0, _label.Label)(NamedAxis[this.axisIdentifier].unit.clone().multiplyScalar(this.length + (params.fontSize || 1)), params);
    }
}
class Axes extends (0, _plot.Framed) {
    constructor(lengthX, lengthY, lengthZ, axesParams, gridsParams){
        super();
        this.lengthX = lengthX;
        this.lengthY = lengthY;
        this.lengthZ = lengthZ;
        this.axesConfig = new (0, _axesConfig.AxesConfig)(axesParams);
        this.gridsConfig = new (0, _axesConfig.GridConfig)(gridsParams);
    ...
    setGrids() {
        if (this.gridsConfig.xz) {
            const gridXZ = new (0, _three.GridHelper)(Math.max(this.lengthX, this.lengthZ));
            gridXZ.position.setX(this.lengthX / 2);
            gridXZ.position.setZ(this.lengthZ / 2);
            this.drawables.push(gridXZ);
        }
        if (this.gridsConfig.xy) {
            const gridXY = new (0, _three.GridHelper)(Math.max(this.lengthX, this.lengthY));
        ...
        if (this.gridsConfig.yz) {
            const gridYZ = new (0, _three.GridHelper)(Math.max(this.lengthY, this.lengthZ));
...
},{"three":"ktPTu","three/examples/jsm/lines/Line2":"kgvYG","three/examples/jsm/lines/LineGeometry":"5c0fE","three/examples/jsm/lines/LineMaterial":"insFK","./axes.config":"lier3","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./plot":"hsxxN","./label":"dyAII"}],"lier3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AxesConfig", ()=>AxesConfig);
parcelHelpers.export(exports, "AxisConfig", ()=>AxisConfig);
parcelHelpers.export(exports, "GridConfig", ()=>GridConfig);
...
class GridConfig extends (0, _baseConfig.BaseConfig) {
    constructor(params){
        super();
...
class BaseConfig {
    ...
    reproduceNTimes(item, n) {
        return Array.from({
            length: n
        }, ()=>item);
    }
    expandDefaultIfNotExpanded(item, n) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hsxxN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Framed", ()=>Framed);
...
},{"troika-three-text":"7YS8r","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kKQFI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
    ...
    constructor(points, params){
        ...
        this.drawables = points.map((v, i)=>{
            ...
            const material = new (0, _three.MeshBasicMaterial)({
                color: this.config.markerColor[i]
            });
...
class ScatterPlotConfig extends (0, _baseConfig.BaseConfig) {
    ...
    refineScatterPlotParams(nPoints) {
        return (0, _scatterplotParams.scatterplotParams).extend({
            markerSize: (0, _scatterplotParams.scatterplotParams).shape.markerSize.refine((arg)=>arg === undefined || typeof arg === "number" || arg.length === nPoints, {
                message: `markerSize[].length !== points.lengths (${nPoints})`
            }),
            markerColor: (0, _scatterplotParams.scatterplotParams).shape.markerColor.refine((arg)=>arg === undefined || typeof arg === "number" || arg.length === nPoints, {
...
},{"./base.config":"aklxY","./scatterplot.params":"fgjyM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fgjyM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const scatterplotParams = (0, _zod.z).object({
    markerSize: (0, _zod.z).union([
        markersizeTypeZod,
        (0, _zod.z).array(markersizeTypeZod)
    ]).default(0.25),
    markerColor: (0, _zod.z).union([
        (0, _zod.z).number(),
        (0, _zod.z).array((0, _zod.z).number())
    ]).default(0x00ff00)
});
...
},{"three":"ktPTu","../axes":"2EXQV","../label":"dyAII","../plot":"hsxxN","./vectorplot.config":"2jQnK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2jQnK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"three":"ktPTu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kb2Cn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PlanePlot", ()=>PlanePlot);
var _three = require("three");
var _plot = require("../plot");
class PlanePlot extends (0, _plot.Plot) {
    constructor(p1, p2, p3){
        ...
        const geometry = new (0, _three.PlaneGeometry)(size, size);
        const coplanaraPoint = new (0, _three.Vector3)();
...
},{"three":"ktPTu","../plot":"hsxxN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gBWlm","h7u1C"], "h7u1C", "parcelRequire9513")
